				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							...
							<h3 class="h3 font-weight-bold"><?php the_field('why_choose_main_heading'); ?></h1>
					...
					<section class="pt-sm-2 pt-md-5 pd-b-100 our-team-section m-b-75">
						<div class="container">
							<div class="row">
								<div class="col-sm-12 col-md-10">
									<span class="text-uppercase subheader"><?php the_field('meet_our_team_subheader'); ?></span>
									<h1 class="h1"><?php the_field('meet_our_team_main_heading'); ?></h1>
									...
									<div class="col-sm-12 col-md-6">
										<div class="row">
											<div class="col-sm-12 col-md-11 box-image">
												<?php $image = get_field('our_customers_image');
												if( !empty($image) ): ?>
